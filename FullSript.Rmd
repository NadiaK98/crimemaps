...
Need to convert the sf data.fram geometry column into a data.frame with separate x, y columns 
...
tm_shape(surrey_lsoa) + 
  tm_fill("count", style = "sd", title = "sd") + 
  tm_borders(alpha = 0.3)
...
A cartogram is a type of map where different geogrpahic areas are modified based on a variable associated to those areas. 
...
Is there a difference between the cime rate when using workday population compared to residential population? Would we expect to see these trends
